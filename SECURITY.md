...
under `~/.forge-3/` on your machine. Provider keys remain in the shared
local FORGE 3.0 key directory or environment variables. Nothing there is
...
repro steps, affected version (`forge3.core.__version__`), platform,
and impact.
